...
signed main () {
    ...
    double now_val;
    for (long long i = 3; i < 400; ++i) {
        pos_tar = (aa * start_x2 + bb * start_x1 + cc * start_x0) % dd;
        now_val = (double)pos_tar / dd;
        dop1 = start_x2;
        dop2 = start_x1;
        start_x2 = pos_tar;
        start_x1 = dop1;
    ...
    double ans_z = 0;
    for (long long i = 0; i < 20; ++i) {
        ans_z += (double)(z_quan[i] - 20) * (z_quan[i] - 20) / 400.0;
    }
